...
const getOrderById = async (req, res) => {
  ...
  try {
    ...
    apiResponse.Success(res, "Order", { Orders: Order });
  } catch (err) {
...
const getOrdersMoreThanOneLak = async (req, res) => {
  try {
    ...
    apiResponse.Success(res, "Orders with total more than one lak", {
      Orders: morethanorders,
    });
  } catch (err) {
    console.error(err.message);
    apiResponse.ServerError(res, "Server Error", { err: err });
...
const getOrdersLessThanOneLak = async (req, res) => {
  try {
    ...
    apiResponse.Success(res, "Orders with total Less than one lak", {
      Orders: morethanorders,
    });
  } catch (err) {
    console.error(err.message);
...
module.exports = {
  getOrdersToSitemanager,
  getOrdersToSupplier,
  getOrderById,
  getOrdersMoreThanOneLak,
  getOrdersLessThanOneLak,
  updateOrderStatus,
  getOrders,
  deleteOrder,
  createOrder,
